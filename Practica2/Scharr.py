...
# Calcular el gradiente horizontal y vertical con Scharr
gradient_x = cv2.Scharr(image_blurred, cv2.CV_64F, 1, 0)
gradient_y = cv2.Scharr(image_blurred, cv2.CV_64F, 0, 1)
